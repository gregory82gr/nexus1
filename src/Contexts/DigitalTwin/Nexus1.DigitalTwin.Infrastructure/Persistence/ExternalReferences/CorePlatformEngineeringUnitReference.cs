...
/// used to declare DigitalTwin.TwinVariable's real (nullable) FK to
/// CorePlatform.EngineeringUnit (ADR-020). Local duplicate of
/// Instrumentation's own internal type — see the sibling reference's XML
/// doc for why duplication, not reuse, is the deliberate choice here.
/// </summary>
