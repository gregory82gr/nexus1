...
/// RadiationMonitoring.RadiationZone/RadiationMonitoring.RadiationMonitor to
/// ReactorFleet.Unit across bounded contexts that share AlarmManagementDb
/// (ADR-024).
///
/// This is NOT a reference to Nexus1.ReactorFleet.Domain — RadiationMonitoring
...
/// EventManagement's/Robotics' own ReactorFleetUnitReference (those types are
/// internal to their own Infrastructure projects, so they cannot be reused
/// directly — deliberate boilerplate, per ADR-020's own guidance, restated in
/// ADR-021/ADR-022/ADR-023/ADR-024: keep shadow entities local to their own
/// project).
/// </summary>
