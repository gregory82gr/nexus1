...
public sealed class MeasurementQualityConfiguration : IEntityTypeConfiguration<MeasurementQuality>
{
    public void Configure(EntityTypeBuilder<MeasurementQuality> builder)
    {
        builder.ToTable("MeasurementQuality", "RadiationMonitoring");
        builder.HasKey(x => x.Id).HasName("PK_RadiationMonitoring_MeasurementQuality");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_RadiationMonitoring_MeasurementQuality_Code");
