...
public sealed class RadiationZoneStatusConfiguration : IEntityTypeConfiguration<RadiationZoneStatus>
{
    public void Configure(EntityTypeBuilder<RadiationZoneStatus> builder)
    {
        builder.ToTable("RadiationZoneStatus", "RadiationMonitoring");
        builder.HasKey(x => x.Id).HasName("PK_RadiationMonitoring_RadiationZoneStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_RadiationMonitoring_RadiationZoneStatus_Code");
