...
public sealed class DosimeterStatusConfiguration : IEntityTypeConfiguration<DosimeterStatus>
{
    public void Configure(EntityTypeBuilder<DosimeterStatus> builder)
    {
        builder.ToTable("DosimeterStatus", "RadiationMonitoring");
        builder.HasKey(x => x.Id).HasName("PK_RadiationMonitoring_DosimeterStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_RadiationMonitoring_DosimeterStatus_Code");
