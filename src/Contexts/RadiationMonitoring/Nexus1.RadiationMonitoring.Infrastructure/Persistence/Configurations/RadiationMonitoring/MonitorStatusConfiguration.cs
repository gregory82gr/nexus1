...
public sealed class MonitorStatusConfiguration : IEntityTypeConfiguration<MonitorStatus>
{
    public void Configure(EntityTypeBuilder<MonitorStatus> builder)
    {
        builder.ToTable("MonitorStatus", "RadiationMonitoring");
        builder.HasKey(x => x.Id).HasName("PK_RadiationMonitoring_MonitorStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_RadiationMonitoring_MonitorStatus_Code");
