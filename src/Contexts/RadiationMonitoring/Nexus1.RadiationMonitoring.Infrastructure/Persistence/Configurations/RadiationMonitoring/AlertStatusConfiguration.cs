...
public sealed class AlertStatusConfiguration : IEntityTypeConfiguration<AlertStatus>
{
    ...
    {
        builder.ToTable("AlertStatus", "RadiationMonitoring");
        builder.HasKey(x => x.Id).HasName("PK_RadiationMonitoring_AlertStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_RadiationMonitoring_AlertStatus_Code");
