...
public sealed class DoseTypeConfiguration : IEntityTypeConfiguration<DoseType>
{
    public void Configure(EntityTypeBuilder<DoseType> builder)
    {
        builder.ToTable("DoseType", "RadiationMonitoring");
        builder.HasKey(x => x.Id).HasName("PK_RadiationMonitoring_DoseType");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_RadiationMonitoring_DoseType_Code");
