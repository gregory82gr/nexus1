...
/// <summary>
/// Thin hosting loop around OutboxRelay. BatchSize/IdleDelay match
/// From_Services_To_Runtime's OutboxDispatcherOptions defaults (ch.27,
/// Executable Asset 27-L) — the lease/recovery-batch/confirm-timeout
/// tunables from that same options type are phase (b) (ADR-008).
/// </summary>
