...
/// <summary>Readiness verdict classification for the mission dispatch gate (ADR-023: BLOCKED/EXPIRED among other codes). Referenced by MissionReadinessAssessment and MissionReadinessItem (both NOT NULL).</summary>
