...
namespace Nexus1.Robotics.Infrastructure.Persistence.ExternalReferences;
...
/// Robotics.Robot/Robotics.Mission to ReactorFleet.Unit across bounded
/// contexts that share AlarmManagementDb (ADR-023).
///
/// This is NOT a reference to Nexus1.ReactorFleet.Domain — Robotics
...
/// EventManagement's own ReactorFleetUnitReference (those types are internal
/// to their own Infrastructure projects, so they cannot be reused directly —
/// deliberate boilerplate, per ADR-020's own guidance, restated in
/// ADR-021/ADR-022/ADR-023: keep shadow entities local to their own project).
/// </summary>
