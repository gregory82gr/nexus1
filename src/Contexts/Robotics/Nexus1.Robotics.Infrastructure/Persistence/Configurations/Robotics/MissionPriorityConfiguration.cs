...
public sealed class MissionPriorityConfiguration : IEntityTypeConfiguration<MissionPriority>
{
    public void Configure(EntityTypeBuilder<MissionPriority> builder)
    {
        builder.ToTable("MissionPriority", "Robotics");
        builder.HasKey(x => x.Id).HasName("PK_Robotics_MissionPriority");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_Robotics_MissionPriority_Code");
