...
public sealed class ReadinessStatusConfiguration : IEntityTypeConfiguration<ReadinessStatus>
{
    ...
    {
        builder.ToTable("ReadinessStatus", "Robotics");
        builder.HasKey(x => x.Id).HasName("PK_Robotics_ReadinessStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_Robotics_ReadinessStatus_Code");
