...
public sealed class LearningAlgorithmConfiguration : IEntityTypeConfiguration<LearningAlgorithm>
{
    public void Configure(EntityTypeBuilder<LearningAlgorithm> builder)
    {
        builder.ToTable("LearningAlgorithm", "ReinforcementLearning");
        builder.HasKey(x => x.Id).HasName("PK_ReinforcementLearning_LearningAlgorithm");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_ReinforcementLearning_LearningAlgorithm_Code");
