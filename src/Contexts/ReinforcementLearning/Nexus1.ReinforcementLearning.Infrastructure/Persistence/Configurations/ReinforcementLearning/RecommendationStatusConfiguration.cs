...
public sealed class RecommendationStatusConfiguration : IEntityTypeConfiguration<RecommendationStatus>
{
    ...
    {
        builder.ToTable("RecommendationStatus", "ReinforcementLearning");
        builder.HasKey(x => x.Id).HasName("PK_ReinforcementLearning_RecommendationStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_ReinforcementLearning_RecommendationStatus_Code");
