...
public sealed class TrainingRunStatusConfiguration : IEntityTypeConfiguration<TrainingRunStatus>
{
    public void Configure(EntityTypeBuilder<TrainingRunStatus> builder)
    {
        builder.ToTable("TrainingRunStatus", "ReinforcementLearning");
        builder.HasKey(x => x.Id).HasName("PK_ReinforcementLearning_TrainingRunStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_ReinforcementLearning_TrainingRunStatus_Code");
