...
public sealed class StateSpaceTypeConfiguration : IEntityTypeConfiguration<StateSpaceType>
{
    public void Configure(EntityTypeBuilder<StateSpaceType> builder)
    {
        builder.ToTable("StateSpaceType", "ReinforcementLearning");
        builder.HasKey(x => x.Id).HasName("PK_ReinforcementLearning_StateSpaceType");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_ReinforcementLearning_StateSpaceType_Code");
