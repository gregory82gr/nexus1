...
public sealed class RewardFunctionTypeConfiguration : IEntityTypeConfiguration<RewardFunctionType>
{
    public void Configure(EntityTypeBuilder<RewardFunctionType> builder)
    {
        builder.ToTable("RewardFunctionType", "ReinforcementLearning");
        builder.HasKey(x => x.Id).HasName("PK_ReinforcementLearning_RewardFunctionType");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_ReinforcementLearning_RewardFunctionType_Code");
