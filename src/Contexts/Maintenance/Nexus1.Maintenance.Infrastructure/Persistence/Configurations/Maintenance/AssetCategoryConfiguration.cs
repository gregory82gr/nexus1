...
public sealed class AssetCategoryConfiguration : IEntityTypeConfiguration<AssetCategory>
{
    ...
    {
        builder.ToTable("AssetCategory", "Maintenance");
        builder.HasKey(x => x.Id).HasName("PK_Maintenance_AssetCategory");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_Maintenance_AssetCategory_Code");
