...
public sealed class ConditionGradeConfiguration : IEntityTypeConfiguration<ConditionGrade>
{
    ...
    {
        builder.ToTable("ConditionGrade", "Maintenance");
        builder.HasKey(x => x.Id).HasName("PK_Maintenance_ConditionGrade");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_Maintenance_ConditionGrade_Code");
