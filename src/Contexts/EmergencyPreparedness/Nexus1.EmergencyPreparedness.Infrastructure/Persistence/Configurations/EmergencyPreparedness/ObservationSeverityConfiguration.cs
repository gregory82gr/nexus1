...
public sealed class ObservationSeverityConfiguration : IEntityTypeConfiguration<ObservationSeverity>
{
    public void Configure(EntityTypeBuilder<ObservationSeverity> builder)
    {
        builder.ToTable("ObservationSeverity", "EmergencyPreparedness");
        builder.HasKey(x => x.Id).HasName("PK_EmergencyPreparedness_ObservationSeverity");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_EmergencyPreparedness_ObservationSeverity_Code");
