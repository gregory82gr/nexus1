...
public sealed class ResourceStatusConfiguration : IEntityTypeConfiguration<ResourceStatus>
{
    public void Configure(EntityTypeBuilder<ResourceStatus> builder)
    {
        builder.ToTable("ResourceStatus", "EmergencyPreparedness");
        builder.HasKey(x => x.Id).HasName("PK_EmergencyPreparedness_ResourceStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_EmergencyPreparedness_ResourceStatus_Code");
