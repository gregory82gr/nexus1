...
public sealed class PlanStatusConfiguration : IEntityTypeConfiguration<PlanStatus>
{
    public void Configure(EntityTypeBuilder<PlanStatus> builder)
    {
        builder.ToTable("PlanStatus", "EmergencyPreparedness");
        builder.HasKey(x => x.Id).HasName("PK_EmergencyPreparedness_PlanStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_EmergencyPreparedness_PlanStatus_Code");
