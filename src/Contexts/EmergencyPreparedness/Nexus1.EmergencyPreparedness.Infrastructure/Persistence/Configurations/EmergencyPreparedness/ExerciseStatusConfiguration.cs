...
public sealed class ExerciseStatusConfiguration : IEntityTypeConfiguration<ExerciseStatus>
{
    public void Configure(EntityTypeBuilder<ExerciseStatus> builder)
    {
        builder.ToTable("ExerciseStatus", "EmergencyPreparedness");
        builder.HasKey(x => x.Id).HasName("PK_EmergencyPreparedness_ExerciseStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_EmergencyPreparedness_ExerciseStatus_Code");
