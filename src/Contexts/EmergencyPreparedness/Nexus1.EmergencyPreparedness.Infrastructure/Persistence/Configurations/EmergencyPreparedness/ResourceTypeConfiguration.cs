...
public sealed class ResourceTypeConfiguration : IEntityTypeConfiguration<ResourceType>
{
    ...
    {
        builder.ToTable("ResourceType", "EmergencyPreparedness");
        builder.HasKey(x => x.Id).HasName("PK_EmergencyPreparedness_ResourceType");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_EmergencyPreparedness_ResourceType_Code");
