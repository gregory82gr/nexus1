...
public sealed class DepartmentTypeConfiguration : IEntityTypeConfiguration<DepartmentType>
{
    ...
    {
        builder.ToTable("DepartmentType", "Organization");
        builder.HasKey(x => x.Id).HasName("PK_Organization_DepartmentType");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_Organization_DepartmentType_Code");
