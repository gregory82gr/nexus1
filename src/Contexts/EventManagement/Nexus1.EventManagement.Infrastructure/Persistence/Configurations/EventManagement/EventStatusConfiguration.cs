...
public sealed class EventStatusConfiguration : IEntityTypeConfiguration<EventStatus>
{
    ...
    {
        builder.ToTable("EventStatus", "EventManagement");
        builder.HasKey(x => x.Id).HasName("PK_EventManagement_EventStatus");
        ...
        builder.HasIndex(x => x.Code).IsUnique().HasDatabaseName("UQ_EventManagement_EventStatus_Code");
