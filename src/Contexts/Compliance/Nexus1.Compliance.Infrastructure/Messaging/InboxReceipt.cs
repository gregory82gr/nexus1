...
/// <summary>
/// Mirrors Nexus1.Audit.Infrastructure.Messaging.InboxReceipt exactly
/// (ADR-008/ADR-011) — transport-level dedup only. The semantic half of
/// Compliance's two-key dedup oracle (ch.34 34-AO) lives on ComplianceReview's
